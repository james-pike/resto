      ...
      <div className='overflow-x-hidden hidden md:block'>
        ...
        <div className='px-72 w-[80%] h-screen flex flex-col justify-center text-white space-y-5'>
          ...
          <span className='text-neutral-200'>
            ...
            quidem, molestiae id quia necessitatibus veritatis dolorum reprehenderit totam eligendi
            aliquid quo suscipit praesentium commodi optio! Animi eaque omnis, velit et alias
            inventore maxime mollitia accusamus laborum rem! Est dolor veniam hic ad eos illum
            similique maxime harum, eveniet eum in neque quidem magnam consectetur facere tempora
            animi error repellat aliquid sequi praesentium! Quidem nisi, perferendis blanditiis
            quam placeat voluptate optio provident eveniet voluptatum modi sequi dolorum repellat
            ipsam doloremque consectetur, autem voluptas fugiat reiciendis ullam ipsum eum!
            Excepturi nesciunt et facere. Voluptas error quam excepturi expedita quod!
          </span>
